...
{
    public partial class MapDirectionPage : ContentPage
    {
        public static readonly BindableProperty CalculateCommandProperty =
            BindableProperty.Create(nameof(CalculateCommand), typeof(ICommand), typeof(MapDirectionPage), null, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty UpdateCommandProperty =
          BindableProperty.Create(nameof(UpdateCommand), typeof(ICommand), typeof(MapDirectionPage), null, BindingMode.TwoWay);
        ...
        void AddMapStyle()
        {
            var assembly = typeof(MapDirectionPage).GetTypeInfo().Assembly;
            var stream = assembly.GetManifestResourceStream($"possibilityZC.MapStyle.json");
            string styleFile;
        ...
        public static readonly BindableProperty GetActualLocationCommandProperty =
            BindableProperty.Create(nameof(GetActualLocationCommand), typeof(ICommand), typeof(MapDirectionPage), null, BindingMode.TwoWay);
